...
# this uses new extractions with better? bias subtraction
...
dataDir = "/Volumes/futa/utah/rot7/"
...
for imgNum in imgNums:
    ...
    imgName = "movie7/dxy-%s-%s.png"%(centtype, movieNumStr)
...
if savedxys:
    ...
    dxyDF.to_csv("movie7/dxyPixels-%s.csv"%centtype)
